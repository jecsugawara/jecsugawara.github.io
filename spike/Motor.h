...
public:
  ...
  /** 
   * @brief モーターの回転速度を設定する 
   * @param speed モーターの回転速度 [°/秒] 
   * @return - 
   */ 
  ...
  /** 
   * @brief モーターのパワー値を設定する 
   * @param power モーターのパワー値（-100 ～ +100） 
   * @return - 
   */ 
   ...
   * @details Motorでは複数生成が問題ないので、常にfalseを返す  
   */
